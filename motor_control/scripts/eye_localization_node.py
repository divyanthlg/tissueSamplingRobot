...
class eyeDetectionNode:

    def __init__(self):
        rospy.init_node("eye_detection_node")
        self.counter_ = 0
        self.model = YOLO('/home/divyanthlg/workspaces/potato_ws/src/motor_control/eye_detection_yolov8.pt')
        ...
        self.eye_color_publisher = rospy.Publisher('eye_detection_image', Image, queue_size=10)
        self.eye_depth_publisher = rospy.Publisher('eye_location', Point, queue_size=10)
        self.results = None
    ...
    def callback_color_image(self, color_message):
        ...
        self.eye_color_publisher.publish(detection_image)
